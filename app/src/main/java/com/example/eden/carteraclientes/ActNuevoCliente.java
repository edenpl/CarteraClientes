package com.example.eden.carteraclientes;

import android.database.sqlite.SQLiteDatabase;
import android.os.Bundle;

import com.example.eden.carteraclientes.BaseDatos.DatosOpenHelper;
...
public class ActNuevoCliente extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        inflater.inflate(R.menu.menu_act_nuevo_cliete,menu);
